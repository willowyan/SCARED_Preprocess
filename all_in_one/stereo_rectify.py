...
"""
Rectify stereo image pairs and also generate reprojection matrix 
(which will be used for disparity-to-depth conversion).
"""

def rectify(frame_parameter_file, left_raw, right_raw):
    """
    Returns: rectified left and right images, and reprojection matrix Q
    """
...
def save_Q(Q, reprojection_file):
    # Savese reprojection matrix to a JSON file
